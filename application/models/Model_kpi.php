...
class Model_kpi extends CI_Model {
	...
	public function datakpi_npl_Per_Kol($tahun = '', $bulan = '', $tanggal = '', $kode_group3 = '', $kode_kantor = ''){ // GET VIEW NPL ALL KOLEKTOR
		$this->db->query("SELECT '$tahun-$bulan-$tanggal' INTO @pv_per_tgl");
		return $this->db->query("SELECT * FROM kms_kpi.v_kpi_npl_kolektor WHERE kode_group3 = '$kode_group3'");
	}
	...
	public function datakpi_CR_Per_Kol($tahun = '', $bulan = '', $tanggal = '', $kode_group3 = '', $kode_kantor = ''){ //GET VIEW COLLECTION RATIO Per KOLEKTOR
		$this->db->query("SELECT '$tahun-$bulan-$tanggal' INTO @pv_per_tgl");
		return $this->db->query("SELECT * FROM kms_kpi.v_kpi_cr_kolektor WHERE kode_group3 = '$kode_group3'");
	}
	...
	public function datakpi_BZ_Per_Kol($tahun = '', $bulan = '', $tanggal = '', $kode_group3 = '', $kode_kantor = ''){ //GET VIEW BUCKET ZERO Per KOLEKTOR
		$this->db->query("SELECT '$tahun-$bulan-$tanggal' INTO @pv_per_tgl");
		return $this->db->query("SELECT * FROM kms_kpi.v_kpi_bz_kolektor WHERE kode_group3 = '$kode_group3'");
	}
