...
class Home extends CI_Controller
{
	...
	public function verifikasiKredit($value = '')
	{
		...
		if ($queryVerifKredti) {
			if ($ao_to_email == 'Kantor') {
				...
				$toemail = 'bams.watanabe@gmail.com, adisuyadi.kdpms@gmail.com, Heinrichricky@gmail.com'; //TO AO
			}
	...
	public function AddMemoKreditCaKendaraan($value = '')
	{
		...
		if ($ao_to_email == 'Kantor') {
			...
			$toemail = 'bams.watanabe@gmail.com, adisuyadi.kdpms@gmail.com'; //TO AO
		}
		$subject = 'PERSETUJUAN';
		$message = "
	    <div style='padding:2%;background-color:white;'>
