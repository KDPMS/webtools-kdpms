				...
				<div class="modal-body">
					<div class="row justify-content-center">
						<?php foreach ($datakpilendingAO as $res) { ?>
							<span class="rounded-circle" data-popover="popover" data-content='<b> Lending : <?= ubahJuta($res->jml_value); ?> <br> Lending (%) : <?= ambil2Angka($res->jml_value / $res->jml_max_value * 100) . ' %'; ?> <br> Status : <?= getStatusLendingAO($res->jml_value); ?> </b>' data-html='true' data-placement='top' data-trigger='hover'>
