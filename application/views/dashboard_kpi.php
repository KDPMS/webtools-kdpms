	...
	<div class="row justify-content-center">
		<?php if ($dataKpiLending || $dataKpiNpl || $dataKpiCR || $dataKpiBZ) { ?>
			...
			<?php if ($dataKpiLending != null) { ?>
				<span class="rounded-circle spedo" data-popover="popover" data-content='<b> Lending : <?= ubahJuta($dataKpiLending[0]->jml_value); ?> <br> Lending : <?= ambil2Angka($dataKpiLending[0]->lending) . ' %'; ?> <br> Status : Bagus </b>' data-html='true' data-placement='top' data-trigger='hover'>
			...
			<?php if ($dataKpiNpl != null) { ?>
				<span class="rounded-circle spedo" data-popover="popover" data-content='<b>NPL : <?= ambil2Angka($dataKpiNpl[0]->jml_value) . " %"; ?> <br> Status : Bagus <br> Baki debet NPL : <?php echo rupiah($dataKpiNpl[0]->jml_bd_npl); ?> <br> Baki debet : <?php echo rupiah($dataKpiNpl[0]->jml_bd); ?></br>' data-html='true' data-placement='top' data-trigger='hover'>
			...
			<?php if ($dataKpiCR != null) { ?>
				<span class="rounded-circle spedo" data-popover="popover" data-content='<b>CR : <?= ambil2Angka($dataKpiCR[0]->jml_value) . " %"; ?> <br> Status : Bagus <br> Jumlah tagihan : <?= rupiah($dataKpiCR[0]->jml_tagihan); ?> <br> Jumlah bayar : <?= rupiah($dataKpiCR[0]->jml_bayar); ?></b>' data-html='true' data-placement='top' data-trigger='hover'>
				...
				<div class="modal-body">
					<div class="row justify-content-center">
						<?php foreach ($datakpilendingAO as $res) { ?>
							<span class="rounded-circle" data-popover="popover" data-content='<b> Lending : <?= ubahJuta($res->jml_value); ?> <br> Lending : <?= ambil2Angka($res->lending) . '%'; ?> <br> Status : Bagus </b>' data-html='true' data-placement='top' data-trigger='hover'>
