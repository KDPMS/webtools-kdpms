	...
	<div class="row justify-content-center">
		<?php if ($dataKpiLendingAO /**|| $dataKpiBZ_AO*/|| $dataKpiNS_AO) { ?>
			...
			<?php if ($dataKpiLendingAO != null) { ?>
				<span class="rounded-circle spedo" data-popover="popover" data-content="<b>Lending : <?= ubahJuta($dataKpiLendingAO[0]->jml_value); ?> <br> Lending (%) : <?= ambil2Angka($dataKpiLendingAO[0]->jml_value / $dataKpiLendingAO[0]->jml_max_value * 100) . ' %'; ?> <br> Status : <?= getStatusLendingAO($dataKpiLendingAO[0]->jml_value); ?></b>" data-html="true" data-placement="top" data-trigger="hover">
